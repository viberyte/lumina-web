...
print("=== LUMINA VENUE TAGGING WITH MASTER SCHEMA ===\n")
print(f"Model: {FINE_TUNED_MODEL}")
print(f"Using controlled vocabulary from LUMINA_COMPLETE_TAGS.json\n")
...
print(f"\n🎉 ALL VENUES TAGGED WITH MASTER SCHEMA!")
print(f"   - Cuisines with style modifiers")
print(f"   - Multi-select occasions")  
print(f"   - Controlled vocabulary for filtering")
