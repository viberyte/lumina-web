...
async function main() {
  console.log('APIFY COMPLETE DATA EXTRACTOR (FIXED)\n');
  ...
  for (const venue of venues) {
    ...
    if (stats.processed % 10 === 0) {
      console.log(`\n📊 PROGRESS: ${stats.processed}/${venues.length} | Menus: ${stats.menusFound} (${stats.totalMenuItems} items) | Events: ${stats.totalEvents}`);
    }
  }
  ...
  console.log(`Skipped: ${stats.skipped} (invalid URLs)`);
