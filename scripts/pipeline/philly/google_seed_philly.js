...
async function run() {
  ...
  console.log("🔍 Starting COMPREHENSIVE Google Places discovery for Philly...");
  ...
  fs.writeFileSync("google_seed_philly.json", JSON.stringify(finalData, null, 2));
  console.log("💾 Saved to google_seed_philly.json");
}
