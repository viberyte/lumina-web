...
const INPUT_FILE = "super_enriched_richmond.json";
const OUTPUT_FILE = "tiktok_enriched_richmond.json";
...
async function classify(venue, tiktokData) {
  ...
  const prompt = `Analyze TikTok videos for ${venue.venueName} in Richmond.
...
async function main() {
  ...
  console.log(`🎥 TIKTOK ENRICHING Richmond:`);
  ...
  for (let i = 0; i < remaining.length; i++) {
    ...
    const query = `${venue.venueName} Richmond`;
