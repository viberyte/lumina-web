...
const OUTPUT_FILE = "instagram_enriched_richmond.json";
...
async function classifyIG(venue, igData) {
  ...
  const prompt = `Analyze Instagram content for ${venue.venueName} in Richmond.
...
async function main() {
  ...
  console.log(`📸 INSTAGRAM ENRICHING Richmond:`);
