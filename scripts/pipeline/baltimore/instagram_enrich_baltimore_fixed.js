...
const OUTPUT_FILE = "instagram_enriched_baltimore.json";
...
async function classifyIG(venue, igData) {
  ...
  const prompt = `Analyze Instagram content for ${venue.venueName} in Baltimore.
...
async function main() {
  ...
  console.log(`📸 INSTAGRAM ENRICHING Baltimore:`);
